    ...
    const renderChart = () => {
        if (!selectedIndicator) return (
            <div className="flex items-center justify-center h-64 text-gray-500">
                Please select an indicator to view the chart
            </div>
        );

        const data = chartData[selectedIndicator.value] || [];
        ...
        const chartType = selectedIndicator.chartType;
        const colors = ['#3b82f6', '#fbbf24', '#22c55e', '#a21caf', '#ef4444'];
        ...
        switch (chartType) {
            ...
            default:
                return (
                    <div className="flex items-center justify-center h-64 text-gray-500">
                        Chart type not supported for {selectedIndicator.label}
                    </div>
                );
        }
    };
