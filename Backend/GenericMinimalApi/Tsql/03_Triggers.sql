/****** TRIGGER for Table: [dbo].[ChartConfigs] ******/
SET ANSI_NULLS ON
GO
...
/****** TRIGGER for Table: [dbo].[DataValues] ******/
/****** Object:  Trigger [dbo].[trg_CalculateGrowthAndTotalMetrics]    Script Date: 9/7/2025 10:05:47 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
